...
```
*/
declare function deserializeError(errorObject: ErrorObject | unknown, options?: Options): Error;
...
```
*/
declare function isErrorLike(value: unknown): value is ErrorLike;

export { ErrorLike, ErrorObject, Options, deserializeError, errorConstructors, isErrorLike, serializeError };
